...
function resources(name, paths) {
    ...
    return gulp.src([paths.src, paths.app])
...
gulp.task('resources_js', function(cb) {
    return resources('js', config.js.paths);
});

gulp.task('resources_sass', function(cb) {
    return resources('sass', config.sass.paths);
});

gulp.task('resources_images', function(cb) {
    return resources('img', config.images.paths);
});
